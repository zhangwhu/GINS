...
typedef struct {        /* satellite status type */
    ...
    double  LC[10];		 /* linear combination 0:GF12 1:GF23 2:GF13 3:MW-L12P12 4:MW-L23P12 5:MW-L13P12 6:MP1 7:MP2 8:MP3 9:DIF */
                         
    double  diff[13];    /* diff ambiguity 0-5:dGF12 dGF23 dGF13 dMW12 dMW23 dMW13  6-8:TDCP   9-11:p1p2 p2p3 p1p3 12:dp1+ddopper */
...
EXPORT int  readproduct(const prcopt_t *prcopt, const filopt_t *fopt, nav_t *nav, 
	pcvs_t *pcvss, pcvs_t *pcvsr, stas_t *stas);
EXPORT void freeproduct(nav_t *nav, pcvs_t *pcvs, pcvs_t *pcvr, stas_t *stas);
EXPORT int  readobs(const char *infile, int rcv, const prcopt_t *prcopt, obs_t *obs, 
...
EXPORT int convkml(const char *infile, const char *outfile, gtime_t ts, gtime_t te, 
            double tint, int qflg, int tcolor, int pcolor, int outalt, int outtime);
...
EXPORT void ppppos(rtk_t *rtk, const obsd_t *obs, int n, const nav_t *nav, 
...
EXPORT int  pppcorr_trop(gtime_t time, const double *blh, double *trp, double *var, 
	const nav_t *nav);
EXPORT int  pppcorr_stat(gtime_t time, const double *blh, const int sat, const nav_t *nav);
EXPORT int  pppcorr_stec(gtime_t time, const double *blh, const int sat1,  const int sat2,
...
EXPORT int  ionocorr(gtime_t time, const double *pos, const double *azel, const prcopt_t *opt, 
    int sat, const double *x, const nav_t *nav, double *dion, double *var);
EXPORT int  tropcorr(gtime_t time, const double *pos, const double *azel, const prcopt_t *opt, 
...
/* preprocessing ------------------------------------------------------------ */
EXPORT int  tdcpos(const obsd_t *obs, int n, const nav_t *nav, const prcopt_t *opt, 
    const double *rs, const double *dts, const int *svh, sol_t *sol, ssat_t *ssat);
